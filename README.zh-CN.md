...
`better-test` 把它捕获下来——[Full Context + Lite Control](https://github.com/d-wwei/better-work-skill) 框架里测试那一半。一份持续维护的测试档案 + 一套开发者反馈回路，让同一个已关闭的 bug 不会被重复提报三次。
...
- **[better-work-skill](https://github.com/d-wwei/better-work-skill)** — Lite Control + 系列入口。完整设计故事看那里。
...
完整故事：系列入口 README 里的 [Full Context, Lite Control](https://github.com/d-wwei/better-work-skill) 长文。
