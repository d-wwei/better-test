...
- **8 个 L1 Hook + gate.sh 统一入口** — 凭证扫描、derived-view 保护、session 隔离、执行日志、完成清单、结果校验。gate.sh 从全局配置自动检测项目（无需逐项目配置）
...
- **Skill 升级管线** — 通用经验排队到 `pending-skill-upgrades.md`，审核后升级 skill
